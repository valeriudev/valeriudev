...
- [Remove stray amiable-modal.png screenshot](https://github.com/lexiprep/lexiprep/pull/8) — [lexiprep/lexiprep](https://github.com/lexiprep/lexiprep) · _15 hours ago_
- [Merge develop into master: word-modal book source line](https://github.com/lexiprep/lexiprep/pull/7) — [lexiprep/lexiprep](https://github.com/lexiprep/lexiprep) · _18 hours ago_
- [Merge develop into master: open-history book sort, dev hot-reload, Postgres MCP](https://github.com/lexiprep/lexiprep/pull/6) — [lexiprep/lexiprep](https://github.com/lexiprep/lexiprep) · _18 hours ago_
