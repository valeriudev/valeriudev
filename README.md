...
- [\[Server\] Always emit `items` for array tool parameter schemas](https://github.com/modelcontextprotocol/php-sdk/pull/378) — [modelcontextprotocol/php-sdk](https://github.com/modelcontextprotocol/php-sdk) · _3 weeks ago_
